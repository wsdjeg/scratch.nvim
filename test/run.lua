...
-- Read PATTERN from environment variable (set by Makefile)
local pattern = os.getenv('TEST_PATTERN') or ''
...
local function run_tests()
    ...
    print('=== Scratch.nvim Test Suite ===')
    if pattern and pattern ~= '' then
        print(string.format('Filter: %s', pattern))
    end
